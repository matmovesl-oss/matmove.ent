...
export function ReviewPage() {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      // Ensure every captured field routes accurately to your live DB
      ...
      // Clean routing to final success
  ...
  return (
    <OnboardingShell step={7}>
      <div className="ob-page animate-in text-center">
        ...
        <p className="text-slate-500 mb-10">Your verification is under review.</p>
